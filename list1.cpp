...
void sort_books(DoublyLinkedList<Book> &books, const std::string &field) {
    if (field == "name") {
...
// a function to print all the books from the container to the txt file
